...
// import { databese } from '../../../firebase/index';
  ...
  return (
    <>
      ...
      <div className="c-section-container">
        ...
        <TextInput
          fullWidth={true} label={"(必須)作品名：テキストボックス※既存チェック"} multiline={false} required={true}
...
　　　　　<div>他の項目も入力する（以下通常維持はhide)</div>
    ...
    　/> */}
      ...
      <ul>
        ...
        <li>
          <Link href="/post/[id]/work/[onework]" as={`/post/${id}/work/kirikiri`}>
            <a>onework</a>
          </Link>
        </li>
      </ul>
