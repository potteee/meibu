...
const handlerGetWinfo = async(req, res) => {
  console.log("apiStart");
  var admin = require("firebase-admin");
  const workId = req.query.wid;
  console.log(workId+"+workId api");
  ...
  let winfoRef = FirestoreSDK.collection('wInfo').doc(workId)
...
export default handlerGetWinfo